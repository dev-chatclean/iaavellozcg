...
// Os adapters em src/infrastructure sao o unico lugar com I/O. Esta regra e o
// que impede a arquitetura de apodrecer — sem ela, em alguns meses o dominio
// volta a importar axios.
//
...
module.exports = [
    ...
    {
        // RATCHET DO LEGADO.
        // A rede de seguranca e zero-mudanca-de-comportamento: nao corrigimos o
        // legado agora. Estes arquivos ficam em 'warn' e SAEM desta lista
        // conforme cada um e estrangulado. A lista so encolhe — nunca adicione
        // arquivo novo aqui.
        files: [
            'index.js',
            'store.js',
