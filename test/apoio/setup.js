...
// devem depender apenas do que definem explicitamente. Sem os DEPT_ID_*, o
// codigo cai nos padroes do data.js, que sao deterministicos.
...
delete process.env.TRANSFERIR_DEPARTAMENTO;
delete process.env.TRANSFERIR_FECHANDO;
delete process.env.DEPT_ID_MATRIZ;
delete process.env.DEPT_ID_MALVINAS;
delete process.env.DEPT_ID_MONTEIRO;
delete process.env.DEPT_ID_AGENTE_IA;
delete process.env.DEPT_ID_POSVENDA;
