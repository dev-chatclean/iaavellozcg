...
describe('parsePayload: formato aninhado do ChatClean', () => {
    ...
    // O SenderAlt tem PRIORIDADE sobre o contact.number. A razao e concreta: o
    // SenderAlt do whatsmeow vem como JID completo ("5584...:59@s.whatsapp.net"),
    // entao o ID do dispositivo (:59) e cortado corretamente. O contact.number do
    // CRM as vezes chega com esse sufixo ja grudado ("55849461084559"), sem os
    // dois-pontos — e ai nao ha como separar o telefone do dispositivo.
    // Em contas com LID, o SenderAlt tambem e quem carrega o telefone real
    // (Chat/Sender vem como "14079406125304@lid").
    it('prefere SenderAlt a contact.number quando ambos existem', () => {
        const r = parsePayload(
            aninhado({
    ...
    it('o SenderAlt com id de dispositivo vence o contact.number sem separador', () => {
        const r = parsePayload(
            aninhado({
                contact: { number: '55849175644624' }, // :24 grudado, indistinguivel
